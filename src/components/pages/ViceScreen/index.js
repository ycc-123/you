...
import { getStockGoods,getWarehouse,getGoodsByWarehouseId } from '@/action'
...
class index extends Component {
	...
	componentDidMount() {
        ...
        this.props.getWarehouse().then(res=>{
            console.log(res)
        })
...
export default connect(null, { getStockGoods,getWarehouse,getGoodsByWarehouseId })(index)
